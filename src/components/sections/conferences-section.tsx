...
const conferences = [
  {
    year: "2024",
    title: "Культура. Образование. Цивилизация",
    type: "Международная",
  ...
  {
    year: "2024",
    title: "Актуальные проблемы социально-экономического образования",
    type: "Всероссийская",
    place: "БГПУ им. М. Акмуллы, Уфа",
    status: "Состоялась",
  },
  {
    year: "2023",
    title: "Педагогическая культурология: теория и практика",
    type: "Международная",
    place: "Онлайн / БГПУ им. М. Акмуллы",
    status: "Состоялась",
  },
  {
    year: "2023",
    title: "Молодёжь. Наука. Общество",
    type: "Межрегиональная",
    place: "БГПУ им. М. Акмуллы, Уфа",
    status: "Состоялась",
  },
  {
    year: "2025",
    title: "Культурология и современное образование",
    type: "Всероссийская",
    place: "БГПУ им. М. Акмуллы, Уфа",
    status: "Планируется",
  },
  {
    year: "2025",
    title: "Экономические и правовые основы педагогического образования",
    type: "Международная",
    place: "Онлайн / БГПУ им. М. Акмуллы",
    status: "Планируется",
  },
